Description of the types of vertex currently supported. In doubt, refer to [`dev/include/uapi/linux/provenance_types.h`](https://github.com/CamFlow/camflow-dev/blob/dev/include/uapi/linux/provenance_types.h).
