...
```
We can see that some provenance JSON has indeed been generated. You can check [here](https://github.com/CamFlow/CamFlow.github.io/wiki/JSON-output) to see what this data means. Publishing the provenance is the job of `camflowd`, lets look at its configuration to understand what it is doing:
```
